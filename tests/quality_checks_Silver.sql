...
=============================================================
Script porpuse :
  This script performs various qulity checks for data consistency, accuracy,
  and standardization across the 'Silver' schema. It inclouds checks for:
  -Null or duplicate primery keys.
...
----------------------------------------------------------------------------------
-->>Check for relation between tables 
